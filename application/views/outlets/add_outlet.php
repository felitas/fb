      ...
      <div class="span12">
        ...
        <hr>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" placeholder="Nama Toko" name="outlet_name" id="required">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" placeholder="Password" name="outlet_password"">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-control text full-size" data-role="input">
                        <input type="number" placeholder="Perbedaan Dasar Harga dengan Toko Utama" name="outlet_margin">
                    </div>
                </div>
            </div>
