			...
			<div class="row-fluid">
					...
					<div class="control-group">
						<div class="span6">
							...
							<div class="controls">
								<input type="number" placeholder="Harga Beli" name="product_purchase_price" class="span12" min="0">
							</div>	
						</div>
						<div class="span6">
							<label for="" class="control-label" class="span12">Harga Jual</label>
							<div class="controls">
								<input type="number" placeholder="Harga Jual" name="product_selling_price" id="product_selling_price" class="span12" min="0">
							</div>	
						</div>	
					</div>
